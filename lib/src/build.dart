...
class CoreBuild extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    switch (styleModel?.overflow) {
      case OverflowType.scroll:
        widgetTree = SingleChildScrollView(
            child: widgetTree,
            scrollDirection: styleModel?.overflowDirection ?? Axis.horizontal);
        break;
      ...
      case OverflowType.visible:
        ...
        break;
      case null:
        widgetTree = Container(child: widgetTree);
        break;
    }
    ...
    if (widgetTree == null) widgetTree = Container();
...
class TxtBuild extends StatelessWidget {
  TxtBuild({required this.text, this.textModel});
